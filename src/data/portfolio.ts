...
export const experiences = [
  {
    ...
    website: "https://www.goautomate.studio/",
    linkedin: "https://www.linkedin.com/company/goautomatestudio/"
  },
  {
    company: "XimVerse",
    role: "Co-Founder",
    ...
    website: "https://ximverse.com/",
    linkedin: "https://www.linkedin.com/company/ximverse/"
  },
  {
...
export const n8nProjects = [
  ...
  },
  {
    ...
    features: [
      "Traders, buyers, sellers workflows with multi-step conditional routing",
      "Auto emails to admins/users triggered by specific lifecycle events",
      "Programmatic PDF generation via template APIs with custom branding",
      "Send PDFs in different formats and compression levels",
      "Background updates and automated state synchronization",
      "Daily payment and contract renewal reminders with automated escalations",
      "End-to-end process automation reducing manual back-office tasks by 90%",
      "Concurrent operations spanning multiple databases (PostgreSQL, Neon DB)",
      "Synchronous website + n8n integration using webhook hooks"
    ],
  ...
  },
  {
  ...
  } ,
   {
    ...
    features: [
      "Dataset upload via website (Webhook) with initial size and format check",
      "Data cleaning, normalisation & storage on AWS S3 & RDS structures",
      "AI-powered insights, correlations & visual graphs generation via OpenAI API",
      "Business improvement suggestions generated by structured LLM parsing",
      "Reusable, cleaned data pipeline for future analysis and comparisons",
      "Interactive chatbot for direct Q&A on uploaded CSV/Excel datasets",
      "Optimised website + n8n integration with real-time feedback",
      "Custom system prompts configuration dynamically adapted to datasets"
    ],
   ...
   
  {
    ...
    features: [
      "Restaurant leads scraping via Apify using targeted Google Maps keywords",
      "Email-based deduplication, domain checking, and smart filtering",
      "Auto-store clean, validated leads directly into Google Sheets",
      "Personalized cold email outreach to each lead with dynamic tags",
      "Scheduled follow-ups with intelligent reply detection logic",
      "Fully automated, adjustable multi-step email sequence structure",
      "Gmail/IMAP integration for monitoring replies and unsubscribes",
      "Comprehensive logs, error handling, and lead status tracking"
    ],
  ...
  },
  {
    ...
    features: [
      "Bulk certificate generation from Google Sheets database records",
      "Dynamic PDF creation with custom templates and variable fields",
      "Personalized content (Name, Date, Score) for each recipient",
      "Automated secure email distribution with PDF attachments",
      "Loop-based sub-workflow processing to handle high volume without timeouts",
      "Error handling, logging, and retry logic for failed deliveries",
      "Delivery status tracking in sheets for verification",
      "Template customization support and flexible formatting options"
    ],
...
export const projects = [
  ...
  },
  {
    ...
    video: "https://www.youtube.com/watch?v=AjDd56x8Q5o",
...
export const education = [
  {
    ...
    grade: "8.72/10.0",
    achievements: [
      "Maintaining a CGPA of 8.72/10.0",
...
export const certifications = [
  {
    name: "Internship Contribution Letter",
    issuer: "FIT - FIRST Information Technology",
    date: "Jun 2026",
    link: "https://drive.google.com/file/d/1_IBnSOe4D8iPqyAWyn-ccEc1ehJ78muE/view?usp=sharing"
  },
  {
    name: "Experience Letter - Automation Developer",
    issuer: "MyAibo",
    date: "Dec 2025",
    link: "https://drive.google.com/file/d/1X3nxQqwbYWwq-BOGktitA-OJoEAf_171/view?usp=sharing"
  },
  {
    name: "Experience Letter - n8n Specialist",
    issuer: "TenderSeal",
    date: "Dec 2025",
    link: "https://drive.google.com/file/d/1vcSf9hJi1i8UeciNYiil_LQChXv9MByU/view?usp=sharing"
  },
  {
    name: "College Ambassador Certificate (Techfest)",
    issuer: "IIT Bombay",
    date: "2024",
    link: "https://drive.google.com/file/d/1iXDYPAEj1HKuWaUll7ik85zMYcMKGcGc/view?usp=sharing"
  },
  {
